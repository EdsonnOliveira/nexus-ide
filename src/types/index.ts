...
export interface NexusAPI {
  ...
  calendar: {
    ...
    getCalendars: () => Promise<CalendarCalendarsSnapshot>;
    getEventsInRange: (startAt: number, endAt: number) => Promise<CalendarRangeEventsSnapshot>;
    createEvent: (input: CalendarCreateEventInput) => Promise<CalendarMutationResult>;
    updateEvent: (input: CalendarUpdateEventInput) => Promise<CalendarMutationResult>;
    deleteEvent: (input: CalendarDeleteEventInput) => Promise<CalendarMutationResult>;
