...
interface SidebarRenderIconProps {
  size?: number;
}

function SidebarRenderIconComponent({ size = 14 }: SidebarRenderIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export const SidebarRenderIcon = memo(SidebarRenderIconComponent);
